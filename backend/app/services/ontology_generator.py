...
Therefore, **entities must be real, tangible subjects that can speak and interact on social media**:
...
B. **Specific types (8, designed based on text content)**:
   ...
   - For example: if the text involves an academic event, you can have `Student`, `Professor`, `University`
   - For example: if the text involves a business event, you can have `Company`, `CEO`, `Employee`
...
class OntologyGenerator:
    ...
    def _build_user_message(
        ...
        # If text exceeds 50,000 characters, truncate (only affects content passed to LLM, does not affect graph construction)
...
4. All entity types must be subjects that can speak in reality; they cannot be abstract concepts
...
"""
    ...
    def _validate_and_process(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Final enforcement to not exceed limit (defensive programming)
