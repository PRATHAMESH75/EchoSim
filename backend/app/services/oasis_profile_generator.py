...
2. Optimized prompt generation for highly detailed personas
...
class OasisProfileGenerator:
    ...
    # Individual-type entities (require generating concrete personas)
    INDIVIDUAL_ENTITY_TYPES = [
        "student", "alumni", "professor", "person", "publicfigure",
        "expert", "faculty", "official", "journalist", "activist"
    ]

    # Group/institutional-type entities (require generating representative personas)
    GROUP_ENTITY_TYPES = [
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        ...
        separately and results merged. Parallel requests are used to improve efficiency.
        ...
        # graph_id must be set to perform a search
    ...
    def _generate_profile_with_llm(
        ...
        - Individual entities: generate a concrete character setup
        - Group/institutional entities: generate a representative account setup
        """
...
- 机构账号发言要符合其身份定位"""
    ...
    def generate_profiles_from_entities(
        ...
        Args:
            ...
            realtime_output_path: File path for real-time writing
                                  (if provided, writes after each generated profile)
    ...
    def _print_generated_profile(self, entity_name: str, entity_type: str, profile: OasisAgentProfile):
        ...
        # Output to console only (avoid duplication — logger no longer outputs the full content)
        print(output)
    ...
    def _save_twitter_csv(self, profiles: List[OasisAgentProfile], file_path: str):
        ...
        - user_char: Used internally in LLM system prompt; determines how the agent thinks and acts
        - description: Displayed externally; visible to other users as a bio
        """
        import csv
    ...
    def _save_reddit_json(self, profiles: List[OasisAgentProfile], file_path: str):
        ...
        Must include the user_id field — this is the key used by OASIS agent_graph.get_agent()
        for matching!
