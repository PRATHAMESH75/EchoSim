...
class AgentActivity:
    ...
    def to_episode_text(self) -> str:
        """
        Convert activity to text suitable for sending to Zep
        ...
        # Return in "agent_name: activity description" format without a simulation prefix
    ...
    def _describe_like_post(self) -> str:
        """Like a post - includes post text and author information"""
    ...
    def _describe_dislike_post(self) -> str:
        """Dislike a post - includes post text and author information"""
        post_content = self.action_args.get("post_content", "")
        post_author = self.action_args.get("post_author_name", "")
...
class ZepGraphMemoryUpdater:
    ...
    All meaningful actions are updated to Zep; action_args includes full context information:
    ...
    def __init__(self, graph_id: str, api_key: Optional[str] = None):
        ...
        # Per-platform activity buffers (each platform accumulates up to BATCH_SIZE before batch send)
        ...
        self._total_items_sent = 0    # Successfully sent activity count to Zep
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args includes full context information (e.g. post text, usernames).
