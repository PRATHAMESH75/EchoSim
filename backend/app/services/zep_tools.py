...
class InsightForgeResult:
    ...
    def to_text(self) -> str:
        ...
        text_parts = [
            ...
            f"Scenario context: {self.simulation_requirement}",
            f"\n### Data Statistics",
...
class PanoramaResult:
    ...
    def to_text(self) -> str:
        ...
        text_parts = [
            f"## Breadth Search Results (Full Panorama View)",
            f"Query: {self.query}",
            f"\n### Statistics",
...
class ZepToolsService:
    ...
    def search_graph(
        ...
        try:
            ...
            # Fall back to local keyword matching search
    ...
    def insight_forge(
        ...
        5. Integrates all results to produce deep insights
...
Return a JSON-formatted list of sub-questions."""
        ...
        try:
            ...
            # Fall back: return variants based on the original question
            return [
                query,
    ...
    def panorama_search(
        ...
        This tool is suitable for scenarios requiring a full picture of events or tracing evolution over time.
    ...
    def interview_agents(
        ...
        INTERVIEW_PROMPT_PREFIX = (
            ...
            "6. Give substantive answers; respond to each question with at least 2-3 sentences\n\n"
        )
        ...
        try:
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Clean up any tool call JSON wrappers
                ...
                # Clean up response text: remove markers, numbers, Markdown, etc.
                ...
                # Strategy 2 (fallback): long text in correctly paired Chinese quotation marks
                if not key_quotes:
    ...
    def _clean_tool_call_response(response: str) -> str:
        """Clean up JSON tool call wrappers from Agent replies, extracting actual content"""
...
2. Questions where different roles may have different answers
3. Cover multiple dimensions including facts, opinions, and feelings
4. Natural language, like a real interview
5. Keep each question under 50 words; be concise
...
Roles to be interviewed: {', '.join(agent_roles)}
...
- You may use **bold** for key terms, but do not use other Markdown syntax"""
...
Please generate an interview summary."""
        ...
        try:
            ...
            # Fall back: simple concatenation
