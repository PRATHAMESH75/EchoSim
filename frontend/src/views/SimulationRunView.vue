...
// Get maxRounds from query params at init time so child components can use it immediately
...
const startGraphRefresh = () => {
  ...
  addLog('Starting graph live refresh (30s)')
...
onMounted(() => {
  ...
  // Record maxRounds config (already obtained from query params at init)
  if (maxRounds.value) {
